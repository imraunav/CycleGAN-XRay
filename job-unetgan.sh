...
#SBATCH --output=output.unet-gan  #change name of ur output file
...
CUDA_VISIBLE_DEVICES=0,1 python train-unet-gan.py
CUDA_VISIBLE_DEVICES=0 python test-unet.py
