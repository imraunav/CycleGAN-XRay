...
#SBATCH --job-name=ResNet-cyle  #change name of ur job
#SBATCH --output=output.resnet  #change name of ur output file
...
CUDA_VISIBLE_DEVICES=0,1 python train-resnet-cycle.py
